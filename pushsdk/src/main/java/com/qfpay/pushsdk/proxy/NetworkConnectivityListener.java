...
public class NetworkConnectivityListener {
     ...
     * attempting to establish, connectivity with another network. If so,
     * {@code mOtherNetworkInfo} will be non-null.
     */
     ...
     * the broadcast about an alternate network that might be available. If this
     * returns a non-null
     * value, then another broadcast should follow shortly indicating whether
     * connection to the
